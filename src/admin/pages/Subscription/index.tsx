...
// TODO
const Subscription: FunctionComponent = ({ children }) => {
...
const columns: Column<SubscriptionModel>[] = [
  // {
  //   Header: '操作',
  //   // accessor: 'id',
  //   Cell: ({ value, original }) => {
  //     const role: Subscription = original;
  //     return (
  ...
  //                                                   try {
  //                                                     if (checked) {
  //                                                       const rp = await SubscriptionPermission.addPermission(
  //                                                         p.id,
  //                                                         role.id
  //                                                       );
  ...
  //                                                       );
  //                                                     } else {
  //                                                       await SubscriptionPermission.deletePermission(
  //                                                         p.id,
  //                                                         role.id
  //                                                       );
